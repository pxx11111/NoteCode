...
import com.example.pxx.notecode.adapter.MyAdapter;
import com.example.pxx.notecode.db.DBManager;
import com.example.pxx.notecode.model.Note;
...
public class Main2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private class NoteClickListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
            ...
            Intent intent = new Intent(Main2Activity.this, EditNoteActivity.class);
            ...
            new MaterialDialog.Builder(Main2Activity.this)
                    ...
                    .callback(new MaterialDialog.ButtonCallback() {
                                  ...
                                  public void onPositive(MaterialDialog dialog) {
                                      DBManager.getInstance(Main2Activity.this).deleteNote(id);
